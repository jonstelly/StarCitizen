    ...
    public class ApiProfile : Profile
    {
        public ApiProfile()
        {
            CreateMap<ApiSolarSystem, SolarSystem>()
                .ForMember(ss => ss.Type, m => m.MapFrom((api, ss) => api.Type == "SINGLE_STAR" ? SolarSystemType.Single : SolarSystemType.Binary))
                ...
                .ForMember(ss => ss.Position, m => m.MapFrom((api, ss) => new Vector3(api.PositionX, api.PositionY, api.PositionZ)))
